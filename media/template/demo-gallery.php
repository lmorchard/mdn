...
-->
    <ul class="gallery">
      ...
      <li class="demo">
        ...
        <p class="byline vcard"><a href="#" class="url fn" title="See Alejandra Divens' profile">Alejandra Divens</a></p>
        <div class="extra">
          <ul class="stats">
      ...
      <li class="demo">
        ...
        <p class="byline vcard"><a href="#" class="url fn" title="See Darryl McConnaughy's profile">Darryl McConnaughy</a></p>
        <div class="extra">
          <ul class="stats">
      ...
      <li class="demo row-first">
        ...
        <p class="byline vcard"><a href="#" class="url fn" title="See Thaddeus Venture's profile">Thaddeus Venture</a></p>
        <div class="extra">
          <ul class="stats">
            <li class="views" title="This demo has been viewed 1,234 times">1,234</li>
            <li class="likes" title="151 people liked this demo">151</li>
      ...
      <li class="demo">
        ...
        <p class="byline vcard"><a href="#" class="url fn" title="See Amanda Parth's profile">Amanda Parth</a></p>
        <div class="extra">
          <ul class="stats">
            <li class="views" title="This demo has been viewed 55 times">55</li>
            <li class="likes" title="7 people liked this demo">7</li>
      ...
      <li class="demo row-first">
        ...
        <p class="byline vcard"><a href="#" class="url fn" title="See Stephanie Acuba's profile">Stephanie Acuba</a></p>
        <div class="extra">
          <ul class="stats">
            <li class="views" title="This demo has been viewed 1,234 times">1,234</li>
            <li class="likes" title="151 people liked this demo">151</li>
      ...
      <li class="demo">
        ...
        <p class="byline vcard"><a href="#" class="url fn" title="See Byron Orpheus' profile">Byron Orpheus</a></p>
        <div class="extra">
          <ul class="stats">
            <li class="views" title="This demo has been viewed 1,234 times">1,234</li>
            <li class="likes" title="151 people liked this demo">151</li>
      ...
      <li class="demo">
        <h2 class="demo-title">
          <a href="demo-detail.php" title="See more about &ldquo;Pork Feathers&rdquo; by Darryl McConnaughy">
            <img src="./img/fpo55.png" alt="" width="200" height="150"> Pork Feathers
          </a>
        </h2>
        <p class="byline vcard"><a href="#" class="url fn" title="See Darryl McConnaughy's profile">Benjamin Jonathan Jonah Jameson-Parker III, Esq.</a></p>
        <div class="extra">
          <ul class="stats">
